...
# Add model 2 to path
sys.path.insert(0, r"C:\Users\Admin\ducmanhjr\sosanh\model 2")

from src.inference.predictor import Predictor

def main():
    test_dir = Path(r"C:\Users\Admin\ducmanhjr\sosanh\ocr_dataset\test")
    ckpt_path = r"C:\Users\Admin\ducmanhjr\sosanh\model 2\runs\crnn_base\best.pt"
    output_csv = r"C:\Users\Admin\ducmanhjr\sosanh\model2_results.csv"
    
    print("Loading Model 2...")
    predictor = Predictor.from_checkpoint(ckpt_path)
    print("Model 2 loaded successfully. Running inference...")
    ...
    print(f"Done Model 2! Results saved to {output_csv}")
